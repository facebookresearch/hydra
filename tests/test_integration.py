...
def test_custom_local_run_workdir(tmpdir,
                                  task_config,
                                  hydra_cfg,
                                  overrides,
                                  expected_dir):
...
@pytest.mark.parametrize('task_config, hydra_cfg, overrides, expected_dir', [
    ({'hydra': {'sweep': {'dir': 'task_cfg', 'subdir': 'task_cfg_${hydra.job.num}'}}},
     {},
     [],
     'task_cfg/task_cfg_0'
     ),
    ({},
     {'hydra': {'sweep': {'dir': 'hydra_cfg', 'subdir': 'hydra_cfg_${hydra.job.num}'}}},
     [],
...
def test_custom_sweeper_run_workdir(tmpdir,
                                    task_config,
                                    hydra_cfg,
                                    overrides,
                                    expected_dir,
