...
@pytest.mark.parametrize(
    ...
    [
        (
            "ray_aws",
            [
                f"hydra.launcher.ray_cluster.cluster_name={cluster_name}",
                ...
                f"hydra.launcher.ray_cluster.provider.key_pair.key_name=hydra_test_{cluster_name}",
                "hydra.launcher.ray_cluster.setup_commands=[]",
                "hydra.launcher.mandatory_install.install_commands=[]",
                f"+hydra.launcher.ray_cluster.worker_nodes={ray_nodes_conf_override}",
                f"+hydra.launcher.ray_cluster.head_node={ray_nodes_conf_override}",
            ],
            Path(sweep_dir),
        )
    ],
