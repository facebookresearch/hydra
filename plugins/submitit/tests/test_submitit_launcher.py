...
from hydra.test_utils.launcher_common_tests import demo_6_sweep_test_impl, \
    demos_sweep_1_job_test_impl, demos_sweep_2_jobs_test_impl, not_sweeping_hydra_overrides
...
def test_not_sweeping_hydra_overrides(sweep_runner):  # noqa: F811
    not_sweeping_hydra_overrides(sweep_runner, overrides=[
        'launcher=fairtask',
        'hydra.launcher.params.queue=local',
