...
from hydra_plugins.hydra_loky_launcher.loky_launcher import LokyLauncher
...
def test_discovery() -> None:
    ...
    assert LokyLauncher.__name__ in [
        x.__name__ for x in Plugins.instance().discover(Launcher)
    ]


@mark.parametrize("launcher_name, overrides", [("loky", [])])
class TestLokyLauncher(LauncherTestSuite):
    """
...
class TestLokyLauncherIntegration(IntegrationTestSuite):
    """
