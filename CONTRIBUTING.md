...
5. Review the Contributor License Agreement ("CLA") transition note below.
...
[GitHub Security Advisories](https://github.com/hydra-ecosystem/hydra/security/advisories/new).
