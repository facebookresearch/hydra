...
Strict mode is disabled by default if `config_path` points to a directory, unlike [the previous example](config_file/) where a configuration file was specified directly.
