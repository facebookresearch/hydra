...
changes in Hydra 1.4; review the other pages in this upgrade section for
changes relevant to your application.
...
They can suppress this migration warning before Hydra initialization:
